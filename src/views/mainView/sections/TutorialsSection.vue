<template>
  ...
  >
    <TutorialCard
      img-src="/photos/tutorial_1.webp"
      text="Jak kupić nieruchomość i nie zwariować? Przewodnik dla początkujących."
    />
    <TutorialCard
      img-src="/photos/tutorial_2.webp"
      text="Czym różni się inwestycja w nieruchomość od zwykłego zakupu?"
    />
    <TutorialCard
